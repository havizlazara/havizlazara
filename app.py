...
st.markdown(f"""
    ...
    .giant-title {{ 
        ...
        margin: 0; line-height: 1.2; background: rgba(31, 78, 121, 0.6); 
        padding: 5px 25px; border-radius: 10px; display: inline-block;
    ...
    .giant-sub {{ 
        ...
        background: rgba(31, 78, 121, 0.6); padding: 2px 20px;
