...
# --- 1. SISTEM LOGIN & LOGOUT (Session State) ---
...
st.markdown(f"""
    ...
    .giant-sub {{ 
        ...
        letter-spacing: 5px; background: rgba(31, 78, 121, 0.7); padding: 5px 20px; border-radius: 8px; display: inline-block;
    }}
...
def load_data():
    ...
    # Fix Kolom (String agar bisa diinput manual)
...
# --- 7. METRICS & 8. GRAFIK (Compact 50% Size) ---
...
# --- 9. DATABASE MONITORING (Dropdown Status) ---
...
if st.session_state['authenticated']:
    ...
    if c_s.button("💾 SIMPAN & SYNC"):
        try:
            # Menggabungkan data yang tidak difilter dengan yang diedit
